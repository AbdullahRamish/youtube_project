...
ramish_1 = pm.MongoClient('mongodb://ramish:ramishroot@ac-cd7ptzz-shard-00-00.lsdge0t.mongodb.net:27017,ac-cd7ptzz-shard-00-01.lsdge0t.mongodb.net:27017,ac-cd7ptzz-shard-00-02.lsdge0t.mongodb.net:27017/?ssl=true&replicaSet=atlas-ac7cyd-shard-0&authSource=admin&retryWrites=true&w=majority')
db = ramish_1['DataSyncPro_2']
collection = db['YouTube']

# Sql Python Connectivity
ramish = pg2.connect(host='localhost', user='postgres', password='root', database='youtube')
cursor = ramish.cursor()
...
st.set_page_config(page_title='YouTube Project By Ramish',layout="wide"   # Page Title
 )
